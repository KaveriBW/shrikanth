...
$remainingMin = abs($_SESSION['countdown'] - $timeSince);
 
//Print out the countdown.
//echo "Time Left $remainingMin Minutes";
 
//Check if the countdown has finished.
if($remainingMin < 1){
   echo '<script language="javascript">';
echo 'alert("Time is Up You Will Logged Out.")';
echo '</script>';
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Knowledge Check</span></div>
...
include_once 'database.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php?q=1" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="thankyou.html?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
</div>
</div></div>
<div class="bg">
...
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td>
  ...
  <td><b><a href="update.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1"  style="margin:0px;background:red "><span class="title1"><b>Done</b></span></a></b></td></tr>';
}
...
<h2 class="glow">TimeLeft:<?php echo $remainingMin;?>Minutes</h2>
